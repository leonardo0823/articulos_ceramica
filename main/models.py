...
class Articulo(models.Model):
    ...
    codigo = models.CharField(_("código"), primary_key=True, max_length=10, validators=[MaxLengthValidator(limit_value=10,
                                                                                        ...
                                                                                        RegexValidator(
                                                                                                       regex=r'^[0-9]*$', message='Solo puede contener números',),
    ])
    nombre = models.CharField(_("nombre"), max_length=50)
    costo = models.DecimalField(_("costo"), max_digits=8, decimal_places=3)
    cantidad_producida_en_el_mes = models.PositiveIntegerField(
        _("cantidad producida en el mes"))
    taller = models.ForeignKey("main.Taller", on_delete=models.CASCADE)
    mes_proceso = models.DateField(
        _("mes de proceso"), auto_now=False, auto_now_add=False, default=mes_proceso_default)
    ...
    class Meta:
        ...
        constraints = [models.CheckConstraint(
            ...
            check=models.Q(
                cantidad_producida_en_el_mes__gt=models.F(
                    'cantidad_rechazada'),
            ),
...
class Taller(models.Model):
    ...
    codigo = models.CharField(_("código"), primary_key=True, max_length=2,
                              choices=TallerCodigo.choices, default=TallerCodigo.VAJILLAS)
